...
.controller("registerCtrl", function (student, $scope) {
    let app = this;
    ...
    app.regUser = function (regData) {
      // loading
      app.loading = true;
      app.loadingMsg = "Hold on, adding user..";

      student.regUser(app.regData).then(function (data) {
        if (data.data.success) {
          app.successMsg = data.data.message;
          app.loading = false;
          app.regData = {}; // clears input fields
          app.NameofFormSubmitted.$setPristine(); 
          app.NameofFormSubmitted.$setUntouched();
        } else {
