    ...
    switch (mailType) {
        ...
        case 'companyAdded':
            return {
                ...
                +data.other_eligibility+'</td></tr><tr><td><strong>Package:</strong></td><td>BTech: '+data.package.BTech.ctc+'<br>MTech: '+data.package.MTech.ctc+'</td></tr><tr><td><strong>Company Accommodation:</strong></td><td>'
